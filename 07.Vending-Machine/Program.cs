    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (item != "End")
            {
                ...
                switch (item)
                {
                    case "Nuts": currentPrice = 2.0;break;
                    case "Water": currentPrice = 0.7;break;
                    case "Crisps": currentPrice = 1.5;break;
                    case "Soda": currentPrice = 0.8;break;
                    case "Coke": currentPrice = 1.0;break;
                    default:
